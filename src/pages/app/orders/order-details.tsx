...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 78a89s7da87fdsa</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">Yuri Dantas</TableCell>
            </TableRow>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">yuri@email.com</TableCell>
            </TableRow>
